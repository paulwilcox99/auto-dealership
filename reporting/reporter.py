...
class Reporter:
    ...
    def print_final_report(self) -> None:
        ...
        lines = [
            ...
            f"  Accounts receivable:    ${loan_portfolio:,.2f}",
            f"  Total assets:           ${current_cash + inventory_value + loan_portfolio:,.2f}",
            f"  Outstanding debt:       ${current_debt:,.2f}",
            f"  Net equity:             ${current_cash + inventory_value + loan_portfolio - current_debt:,.2f}",
            "",
            f"DAILY AVERAGES",
